...
const faqData = [
  ...
  },
  {
    ...
    answer:
      'Да, мы можем забрать и вернуть ваши вещи прямо к вам домой или в офис. Уточните адрес и удобное время у администратора или через сайт.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Да, оплата доступна онлайн любым удобным способом: банковской картой, Apple Pay или Google Pay. Также вы можете оплатить при получении.',
  },
  {
